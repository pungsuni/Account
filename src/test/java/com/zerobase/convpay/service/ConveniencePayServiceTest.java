...
class ConveniencePayServiceTest {
    ...
    void pay_cancel_fail() {
        //given
        PayCancelRequest payCancelequest = new PayCancelRequest(PayMethodType.MONEY,
                ConvenienceType.G25, 99);

        //when
        PayCancelResponse payCancelResponse = conveniencePayService.payCancel(payCancelequest);
